...
# Grade - 12
# Description - This program include an instance method that returns the area of a circle and the smaller circle
...
def start(): # this function calls the functions/classes above to perform tasks
  ...
  c1 = Circle() # creating a c1 object
  ...
  c2 = Circle() # creating a c2 object
